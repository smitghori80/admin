            ...
            <ul class="navbar-nav float-end">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="#"
                        ...
                        <img src={{ Auth::user()->image ? asset('storage/user/' . Auth::user()->image) : asset('/assets/images/users/1.jpg') }}
                            alt="user" class="rounded-circle" width="31">
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end user-dd animated" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href={{ route('profileForm') }}><i class="ti-user me-1 ms-1"></i>
                            My Profile</a>
                        <a class="dropdown-item" href={{ route('ChangePasswordForm') }}><i
                                class="ti-wallet me-1 ms-1"></i>
                            Change Password</a>
                        <a class="dropdown-item" href="javascript:void(0)"><i class="ti-email me-1 ms-1"></i>
                            Inbox</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="javascript:void(0)"><i class="ti-settings me-1 ms-1"></i> Account
                            Setting</a>
                        <div class="dropdown-divider"></div>
