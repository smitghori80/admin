...
class UserPolicy
{
    ...
    {
        return $this->getPermission()->contains('Read_user');
    ...
    {
        // return true;
        return $this->getPermission()->contains('Create_user');
    }
    ...
    {
        return $this->getPermission()->contains('Update_user');
    }
    ...
    {
        return $this->getPermission()->contains('Delete_user');
